...
df_asian = pd.read_csv("https://raw.githubusercontent.com/vikasthamke/Project/main/Medal_List_Combined.csv")
...
df_oly = pd.read_csv("https://raw.githubusercontent.com/vikasthamke/Project/main/Olympics_Medal_List.csv")
